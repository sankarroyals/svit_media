      ...
      <Segment basic className="ml-4">
        <Grid stackable>
            ...
            <Grid.Row>
              {profile.social ? (
                <List>
                  <List.Item>
                    <List.Icon name="mail" />
                    <Link href={`mailto:${profile.social.email}`}>
                  ...
                  {profile.social.facebook && (
                    <List.Item>
                      ...
                      <Link href={`https://www.instagram.com/${ profile.social.instagram }/`}>
                      <List.Content
                        style={{ color: "orange",cursor:"pointer" }}
          ...
          <Grid.Column width={5} stretched style={{ textAlign: "center" }}>
            <Grid.Row>
              <Image size="small" avatar src={profile.user.profilePicUrl} style={{width:"200px",height:"200px"}} />
            </Grid.Row>
            <br />
